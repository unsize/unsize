...
import { H1, H2, H4, H5, Intro, P, Button, Image } from 'style';
            ...
            <div>
                ...
                <Row style={{ marginTop: 50 }}>
                    ...
                    <Col sm={5} xs={12} smOffset={1}>
                        <Image width="100%" height={450} src="http://placebear.com/500/500" />
                    </Col>
                </Row>
                <Row style={{ marginTop: 50 }}>
                    <Col sm={5} xs={12} smOffset={1}>
                ...
                <Row style={{ marginTop: 50 }} center="xs">
                    <Col xs={12}>
                        <H4>We’ve partnered with the following brands for the official launch of our chrome extension</H4>
                    </Col>
                    <Row center="xs" around="xs">
                        <Col sm={3}>
                            <Image width="100%" height={60} src="http://placebear.com/200/70" />
                        </Col>
                        <Col sm={3}>
                            <Image width="100%" height={60} src="http://placebear.com/200/70" />
                        </Col>
